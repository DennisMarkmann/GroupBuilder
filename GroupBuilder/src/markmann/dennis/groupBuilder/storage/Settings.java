...
/**
 * Storage for the settings used in the application. Contains various elements
 * that can be saved via XML file.
 * 
...
public class Settings { // NO_UCD
	...
	private String path = System.getProperty("user.home")
			+ System.getProperty("file.separator") + "GroupBuilder"
	...
	public final void setSendMailAutomatically(
			final boolean sendMailAutomatically) {
