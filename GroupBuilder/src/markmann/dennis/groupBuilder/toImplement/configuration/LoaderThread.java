...
class LoaderThread {
     ...
     * 
     * @param locationConfigFile is the path and filename regarding the configuration file.
     * 
                ...
                while (!Thread.interrupted()) {
                    if (fileChange != f.lastModified()) {
                        try {
                            ...
                            Configuration.properties.load(new FileInputStream(locationConfigFile));

                        } catch (final IOException e) {
                            System.err.println("Can not read properties: " + e.getMessage());
                        }
                    }
