...
/**
 * Used create testData. This contains member and groups. Is going to be
 * replaced with a JUnit test.
 * 
...
public class TestDataCreator {
	...
	public final void fillTestMemberList(final Pojo pojo) {
		...
		creator.createMember("Dennis", "Markmann");
	...
	public final void fillTestGroupList(final Pojo pojo) {
		...
		creator.createGroup("Group1", "");
		creator.createGroup("Group2", "");
		creator.createGroup("Group3", "");
		creator.createGroup("Group4", "");
