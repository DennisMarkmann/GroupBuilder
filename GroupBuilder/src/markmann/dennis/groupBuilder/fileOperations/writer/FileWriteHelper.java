...
/**
 * Helper class for all kind of file writing operations. Initializes the
 * different actions and has some general used methods for the different
 * writers.
 * 
...
public class FileWriteHelper {
	...
	final Element createElement(final Document doc,
			final Element superiorElement, final String name, final String value) {
	...
	final Attr createAttribute(final Document doc,
			final Element superiorElement, final String name, final String value) {
	...
	final void writeFile(final String path, final String fileName,
			final Document doc) {
		...
		try {
			...
			new WriteOperationException(fileName).showDialog();
		}
