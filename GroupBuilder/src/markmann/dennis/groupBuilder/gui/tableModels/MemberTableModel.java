...
import markmann.dennis.groupBuilder.exceptions.NoFilesFoundException;
    ...
    public Object getValueAt(final int rowIndex, final int columnIndex) {
        ...
        case 5:
            ...
            if (this.cols[columnIndex].equals("Remove")) {
                try {
                    button.setIcon(
                            new IconHelper().getIcon("markmann/dennis/groupBuilder/gui/tableModels/icons/Delete_Icon.png"));
                } catch (final FileNotFoundException e) {
                    new NoFilesFoundException(e);
                }
            } else if (this.cols[columnIndex].equals("Edit")) {
                try {
                    button.setIcon(
                            new IconHelper().getIcon("markmann/dennis/groupBuilder/gui/tableModels/icons/Edit_Icon.png"));
                } catch (final FileNotFoundException e) {
                    new NoFilesFoundException(e);
                }
            }
            button.addActionListener(
                    new TableListener(this.pojo, rowIndex, this.pojo.getTranslation(this.cols[columnIndex] + "Member")));
            return button;
